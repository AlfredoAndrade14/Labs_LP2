...
/**
 * Classe de tarnsformação que limpa todos os espaços em branco do texto.
 */
public class CleanSpaces implements Transformacao {
    /**
     ...
     * limpa todos os espaços em branco do texto e retorna a
     * string formatada.
     *
