...
public class BuscaService {
	 ...
	 * 
	 * @param buscaFeita Busca a ser realizada.
	 * @return Resultado das buscas.
	 */
	public DocumentoDTO[] busca(Busca buscaFeita) {
		Map<Documento, Integer> respostaDocumento = buscaFeita.busca(this.ds);
		DocumentoDTO[] documentos = ordena(respostaDocumento);
		this.br.adicionaBusca(buscaFeita, documentos);
		return documentos;
	}
